...
namespace Omni.Core.Components
{
	...
	public sealed class NetworkIsolate : MonoBehaviour
	{
		...
		[SerializeField]
		private bool m_DestroyOnInstantiate = false;

		[SerializeField]
		private bool m_AutoSimulate = true;

		[SerializeField]
		private bool m_DisableRenderer = false;
		...
		public bool DestroyOnInstantiate
		{
			get => m_DestroyOnInstantiate;
		}

		public bool DisableRenderer
		{
			get => m_DisableRenderer;
		}

		internal bool IsInstantiated
		{
			get => m_IsInstantiated;
			set => m_IsInstantiated = value;
		}
			...
			else
			{
				if (m_IsInstantiated)
				{
					...
					foreach (Renderer renderer in renderers)
					{
						...
						renderer.enabled = !m_DisableRenderer;
					}
				}
			}
		}
